...
{\bf PI: Daniel Lassiter,  Inst: Stanford University}; {\bf Co-PI: Cleo Condoravdi,  Inst: Stanford University}
\end{center}
...
(ii) clause-selecting adjectives with varying implicatures of veridicity, e.g., \textit{rude, annoying, likely}; 
